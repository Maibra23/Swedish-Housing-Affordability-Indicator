...
**Test suite:** 654 passed, 0 failed, 1 skipped · 67/67 renders, also in a clean venv
...
| Check | Result |
|---|---|
| `pytest tests/` | **654 passed, 0 failed, 1 skipped** |
...
data; and 654 tests plus 67 renders run on a bare `pytest`.
