...
**Test suite:** 645 passed, 0 failed, 1 skipped · 67/67 renders, also in a clean venv
...
`tests/test_no_hardcoded_counts.py` (80). Nineteen literals across nine files. Scope
...
`tests/test_docs_inventory.py` (101). 19 documents → **9 maintained** plus a 6-file archive.
...
| Check | Result |
|---|---|
| `pytest tests/` | **645 passed, 0 failed, 1 skipped** |
...
data; and 645 tests plus 67 renders run on a bare `pytest`.
