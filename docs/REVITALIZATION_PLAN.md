...
`tests/test_no_hardcoded_counts.py` (89). Nineteen literals across nine files. Scope
...
`tests/test_docs_inventory.py` (133). 19 documents → **9 maintained** plus a 6-file archive.
