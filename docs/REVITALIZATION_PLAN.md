...
`tests/test_no_hardcoded_counts.py` (83). Nineteen literals across nine files. Scope
...
`tests/test_docs_inventory.py` (107). 19 documents → **9 maintained** plus a 6-file archive.
