...
**Test suite:** 661 passed, 0 failed, 1 skipped, 1 xfailed · 67/67 renders, also in a clean venv
...
| Check | Result |
|---|---|
| `pytest tests/` | **661 passed, 0 failed, 1 skipped, 1 xfailed** |
...
data; and 661 tests plus 67 renders run on a bare `pytest`.
