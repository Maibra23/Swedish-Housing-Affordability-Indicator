...
SWEDISH_LABELS: dict[str, str] = {
    ...
    "kd.serie_intervall": "80 % intervall",
    "kd.serie_prognos": "Prognos (länet)",
    "kd.lanets_historik_hover": "<b>%{x}</b><br>SHAI: %{y:,.1f}<extra>Länet</extra>",
    ...
    "ki.syfte_p1": "Alla andra sidor i SHAI visar ett index, och ett index är en jämförelse snarare än ett beslut. Att Stockholm får 6,2 poäng säger att kommunen är ansträngd jämfört med andra, men inte vad du behöver ha på kontot. Den här sidan räknar om samma indata till de två tal ett hushåll faktiskt planerar efter: en kontantinsats och en månadskostnad.",
    "ki.syfte_p2": "Sidan är också den enda som gör regelverket synligt. På övriga sidor ligger reglerna som en fast bakgrund. Här är de variabeln, och det är det som gör priset för varje regeländring läsbart.",
    "ki.syfte_nar_rubrik": "Sidan är rätt verktyg när",
    "ki.syfte_nar_1": "du vill veta om en viss kommun är möjlig för ett visst hushåll, och inte bara hur den rankas",
    "ki.syfte_nar_2": "du vill förstå varför kontantinsatsen blev lättare eller svårare efter en regeländring",
    "ki.syfte_nar_3": "du vill jämföra villa mot bostadsrätt i samma region, vilket är den mest beslutsnära jämförelsen verktyget erbjuder",
    ...
    "sc.syfte_p1": "Sidan är ett stresstest. Den tar ett läns faktiska siffror för valt år och frågar vad överkomligheten skulle bli om räntan, inkomsterna, priserna eller inflationen rörde sig.",
    "sc.syfte_p2": "Alla andra sidor är bakåtblickande och stannar vid sista året SCB publicerat kommunal inkomst. Det här är den enda sidan som kan svara på en framåtblickande fråga. Det är också den enda platsen där realräntans beteende blir synligt, och det beteendet är genuint kontraintuitivt: en räntehöjning som följs av lika stor inflation ändrar ingenting alls.",
    "sc.syfte_nar_rubrik": "Sidan är rätt verktyg när",
    "sc.syfte_nar_1": "du vill veta vilken indata som faktiskt rör överkomligheten i ett visst län, och vilken som knappt märks",
    "sc.syfte_nar_2": "du vill förstå en historisk episod, vilket de förinställda scenarierna är byggda för",
    "sc.syfte_nar_3": "du vill pröva en magkänsla om räntehöjningar innan du agerar på den",
